<div class="row mt-4 ">
    ...
    <div class="row mt-4">
        ...
        <div class="col">
            <select name="gelandang-tengah-kiri" class="form-select form-select-sm" aria-label=".form-select-lg example">
                <option selected>Gelandang tengah kiri</option>
                @foreach ($pemain as $item)
                    <option value="{{$item->id}}">{{$item->nama}} | {{$item->posisi}}</option>
                @endforeach
            </select>
        ...
        <div class="col">
            <select name="gelandang-tengah-kanan" class="form-select form-select-sm" aria-label=".form-select-lg example">
                <option selected>Gelandang tengah kanan</option>
                @foreach ($pemain as $item)
                    <option value="{{$item->id}}">{{$item->nama}} | {{$item->posisi}}</option>
                @endforeach
            </select>
